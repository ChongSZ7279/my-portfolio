...
import SiewZhen from "./data/image/SiewZhen.png"; 
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Hero image carousel (if images provided) */}
            {images.length > 0 && (
                    ...
                    <div className="absolute top-3 left-3 flex gap-2 z-10">
                      {images.map((src, i) => (
                        <button
                          ...
                          style={{
                            borderColor:
                              i === imgIdx ? accent : "rgba(148,163,184,0.35)",
            ...
            <div className="p-6 md:p-7 space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span
                  className="text-xs font-mono uppercase tracking-widest px-2.5 py-0.5 rounded"
              ...
              <div>
                <h3
                  className="font-display text-2xl md:text-3xl font-black leading-snug mb-2"
              ...
              {milestone.link && (
                <div className="pt-1 border-t border-white/5">
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-mono mt-3"
                    style={{ color: accent }}
                  >
                    <span>↗</span>
                    <span className="underline underline-offset-2">
                      {milestone.link.includes("github")
                        ? "View on GitHub"
                        : "Open Link"}
                    </span>
                  </a>
...
/* ─────────────────────────────────────────────
   MILESTONE CARD
───────────────────────────────────────────── */
function MilestoneCard({ milestone, accent, delay }) {
        ...
        >
          <div
            ...
            style={{
              background: hovered
                ? "rgba(15,23,42,0.95)"
                : "rgba(15,23,42,0.75)",
              borderColor: hovered ? `${accent}60` : "rgba(148,163,184,0.12)",
              backdropFilter: "blur(16px)",
              boxShadow: hovered
                ? `0 20px 60px -10px ${accent}25, 0 0 0 1px ${accent}20, inset 0 1px 0 rgba(255,255,255,0.05)`
          ...
          >
            ...
            <div className="relative p-5">
              ...
              {/* Title */}
              <h4
                className="text-base font-bold mb-2 leading-snug font-display"
                style={{
...
/* ─────────────────────────────────────────────
   YEAR BLOCK
───────────────────────────────────────────── */
function YearBlock({ item, index, lineProgress }) {
  const ref = useRef(null);
  const visible = useIntersection(ref);
  const isLeft = item.side === "left";

  // Node glows when close to scroll progress
  const nodePosition = index / (timelineData.length - 1);
  const nodeActive = lineProgress >= nodePosition - 0.03;

  return (
    <div
      ref={ref}
      className="relative flex items-start gap-0 md:gap-6"
      style={{
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: isLeft ? "right" : "left" }}>
            ...
            <div
              className="text-xs font-mono tracking-widest uppercase mt-0.5"
        ...
        <div className="space-y-3">
          {item.milestones.map((m, i) => (
            <MilestoneCard
              ...
              milestone={m}
              accent={item.accent}
              // Small incremental delay so cards appear one-by-one while scrolling
              delay={index * 0.12 + i * 0.1}
            />
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col items-center relative" style={{ width: 48, flexShrink: 0 }}>
        ...
        >
          <div
            ...
            style={{
              width: nodeActive ? 12 : 8,
              height: nodeActive ? 12 : 8,
      ...
      {/* ── Empty space side (desktop balance) ── */}
...
export default function GrowthTimeline() {
  ...
  // Animated fill height for the center line
  const lineHeightPct = `${Math.min(lineProgress * 110, 100)}%`;
  ...
  return (
    <>
      ...
      <section id="journey" className="timeline-section parallax-bg section-y page-x min-h-screen">
        ...
        />
        <div
          className="absolute bottom-1/3 right-0 w-64 h-64 rounded-full pointer-events-none"
          style={{
        ...
        <div className="relative z-10 container-5xl" ref={containerRef}>
            ...
            title={
              <>
                ...
                <span
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #06b6d4 0%, #8b5cf6 60%, #ec4899 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    backgroundClip: "text",
                  }}
          ...
          {/* ── Footer card ── */}
          <div
            className="mt-16 rounded-3xl border p-8 text-center relative overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                {["🚀 Full-Stack", "⛓ Web3", "🤖 AI/ML", "🏆 Hackathons", "📐 System Design"].map(
                  (b) => (
                    <span
                      key={b}
